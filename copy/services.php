    ...
    <ul class="navbar-nav mx-auto font-weight-bold">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item" id="active_page">
        <a class="nav-link text-uppercase ml-4"  href="services.php">Services</a>
      </li>      
		...
		<div class="services">
			<div class="row my-5">
				...
				<div class="col-md-4 col-12">
					...
					<div class="background">
						<h5 class="bottom-big py-2 px-3 ">Web Development</h5>
					</div>
				</div>
			</div>
			...
			<div class="row ">
				...
				<div class="col-md-4 col-12">
					...
					<div class="background">
						<h5 class="bottom-right py-2 px-2">Network Support</h5>
					</div>
				</div>
				<div class="col-md-4 col-12">
					<img src="assets/img/service6.jpg" height="200" width="100%" alt="Data Recovery image loading..">
					<div class="background">
						<h5 class="bottom-right py-2 px-2">Data Recovery</h5>
					</div>
				</div>
			</div>
			<div class="row mt-5">
				...
				<div class="col-md-4 col-12">
					...
					<div class="background">
						<h5 class="bottom-right py-2 px-2">On Home Service</h5>
					</div>
				</div>
			</div>
		</div>
