...
<body onload="myfunction()">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="about-background">
		  <img src="assets/img/about_bg.jpg" height="500" width="100%" alt="image loading...">
	</div>
  ...
  <div class="about_bg">
		<div class="row py-5">
			...
			<div class="col-md-5 col-sm-12 get-in-touch-with-us container-fluid">
        <h1 class="text-uppercase">our Company</h1>
                <p class="pt-3">The ComputersDr provides All Types of Computers Problems in a one Station Like Computer Hardware, Computer Network, Server Supports, Web Designing & Development, Remotely Support, Computer Annual Maintenance Contract (AMC) New Desktop & Laptops, Computer On Rent, All Peripherals providing  Kindly permit us to introduce ourselves as  The ComputersDr  who is highly trained and professionally engaged in Repairing & Maintenance of Computers last 03 years in your city.</p>
			</div>
			
			<div class="col-md-5 col-sm-12 text-center">
				<img src="assets/img/about.png" alt="About image loading.." height="250" width="80%">
    ...
    <div class="row py-5">
      ...
      <div class="col-md-5 col-sm-12 get-in-touch-with-us ">
               <img src="assets/img/mission.png" alt="Mission image loading.." height="300" width="80%">
      </div>
      
      <div class="col-md-5 col-sm-12 container-fluid">
        <h1 class="text-uppercase">Our Mission & Vision</h1>
            <p class="pt-3">The Computers Dr Mission is Our Company believe Our Every project  and Every clients provide by Our Consumer Top class Services. our Mission is to add value to Contribute to our Clients Long term Success and Competitive Strength , The Computer Dr Build Long term Relation Our clients We provides Best  services.</p>
      </div>
