...
<body onload="myfunction()">
  ...
  <div class="about_bg">
        ...
        <h1 class="text-uppercase">Our Company</h1>
                <p class="pt-3">The ComputersDr provides all types of solutions to IT related and computer Problems at one Station. We provide Computer Hardwares, Computer Network, Server Supports, Web Designing & Development, Remotely Support, Computer Annual Maintenance Contract (AMC) New Desktop & Laptops, Computers On Rent, etc.</p>
			</div>
    ...
    <div class="row py-5">
      ...
      <div class="col-md-5 col-sm-12 container-fluid">
        <h1 class="text-uppercase">Our Mission & Vision</h1>
            <p class="pt-3"> At The Computers Dr we believe that every project and every clients should be provided by our best consumer friendly services engraved with expertise. Our Mission is to add value  and to contribute to our Clients Long term Success and Competitive Strength. At The Computers Dr we build long term relation with our clients by providing best services.</p>
      </div>
