<?php 
   ...
   // Mail Send code
		...
		if(isset($_POST['submit_btn'])){
			...
			$mail->SMTPAuth = true;
			$mail->SMTPSecure = 'tls';
			$mail->Username = 'info@thecomputersdr.com';
			$mail->Password = 'Mail@122';

			$mail->setFrom($_POST['email'],$_POST['name']);
			$mail->addAddress('support@thecomputersdr.com');
...
<body onload="myfunction()">
	...
	<div class="contact_body ">
		...
		<div class="row py-5">
			...
			<div class="col-md-5 col-sm-12 get-in-touch-with-us ">
                ...
                <p>
                  <br>
                  <i class="fa fa-phone fa-2x  pr-4"></i> (+91) 9012267671 <br>
                  <i class="fa fa-phone fa-2x pb-4 pr-4"></i> (+91) 9897584992 <br>
          ...
          <div class="form-group">
            ...
            <span id="city_msg" class="text-danger"></span>
					...
					<div class="form-group">
            <select class="form-control my-4" id="userservice" name="service" required>
            ...
            <option>Remotly Support</option>
            <option>Computer Slow</option>
            <option>Virus Problem</option>
            <option>Printer & Catridge</option>
            <option>App Development</option>
            <option>Data Backup & Recovery</option>
            <option>Network Design & Support</option>
            <option>Web designing & Development</option>
            <option>Computer & Laptop Sales & Services</option>
  ...
  function validation(){
    ...
    if((name.length <= 2 || name.length > 20 )){
      document.getElementById('name_msg').innerHTML = "Minimum 3 and Maximum 20 characters are allowed";
      return false;
    }
    ...
    if((city.length <= 4 || city.length > 25)){
      document.getElementById('city_msg').innerHTML = "Minimum 5 and maximum 25 characters are allowed";
      return false;
    }
    ...
    if((msg.length <= 4 || msg.length > 100)){
      document.getElementById('message_msg').innerHTML = "Minimum 5 and maximum 100 characters are allowed";
      return false;
    }
  }
