...
<head>
	...
	<title>TheComputerDr | Desktop & Laptop Repairing | Network Support | Web Designing & Development | Hardware & Software | Looking For Computer Services? </title>
...
<body onload="myfunction()">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto font-weight-bold">
      ...
      <li class="nav-item ml-4">
      <a class="nav-link" title="Need Help? Whatsapp us" target="_blank"  href="https://api.whatsapp.com/send?phone=9012267671&amp;text=Hello,%20I%20am%20Interested%20in%20a%20Your%20Computers%20Repairing%20Services.%20I%20need%20more%20Details.%20Please%20connect%20with%20us%20Whatsapp.%20"><img src="assets/img/whatsapp.png" height="20" width="20"> +91 9012267671</a>
      </li>
    </ul>
  </div>
</nav> 
  ...
  <ol class="carousel-indicators">
    ...
    <li data-target="#carouselExampleIndicators" data-slide-to="3" data-toggle="tooltip" data-placement="top" title="The Perfect Care"></li>
  </ol>
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="100">      
        <img src="assets/img/about_bg.jpg" height="500" class="d-block w-100 " alt="First Slide">
        <div class="carousel-caption ">
        <div class="row">
       
        <div class="col-md-12 col-sm-10  slide-2">
          <h1 class="font-weight-bold">ON – SITE SERVICES PROVIDERS</h1>
  ...
  <div class="carousel-item" data-interval="100">
      <img src="assets/img/carousel4.jpg" height="500" class="d-block w-100" alt="Fourth Slide" >
       <div class="carousel-caption">
        <div class="row">
        ...
        <div class="col-md-12 col-sm-10 slide-2">
          ...
          <br><br>
          <a href="contact.php?#appointment"><button class="btn btn-primary rounded-0 btn-lg text-whit carousel-button" data-toggle="tooltip" data-placemenet="top" title="That's Great">Make An Appointment</button></a>
        </div>
        </div>
      </div>
    </div>
    <div class="carousel-item" data-interval="100">
      <img src="assets/img/carousel5.jpg" height="500" class="d-block w-100" alt="Fifth Slide" >
       <div class="carousel-caption">
        <div class="row">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="choose text-center my-5 container-fluid">
        <h1 class="text-uppercase">Services we provide</h1>        
        ...
        <div class="container">
            <div class="row my-5 ">
              <div class="col-md-3 col-sm-10">
                ...
                <h4 class="my-4">Computer Repairing</h4>
              ...
              <div class="col-md-3 col-sm-10">
                ...
                <h4 class="my-4">Data Recovery</h4>
              ...
              <div class="col-md-3 col-sm-10">
                ...
                <h4 class="my-4">Hardware Parts</h4>
              ...
              <div class="col-md-3 col-sm-10">
                ...
                <h4 class="my-4">Network Solutions</h4>
    ...
    <div class="fast_service">
      <br><br>
      <div class="Service_heading text-center container-fluid text-uppercase">
    ...
    <div class="customer-say py-4">
      ...
      <div class="row py-3  ">          
            ...
            <div class="col-md-3 col-10 text-center">
              <br>
              <img src="assets/img/feedback.jpg" height="300" width="160" class="py-5" alt="Client image loading..">
            </div>            
            <div class="col-md-3 col-10 container-fluid">
              <i class="fa fa-quote-right fa-3x text-primary container-fluid" aria-hidden="true"></i>
              <h4 class="py-3 container-fluid">Keep it up.…. The Computers Dr Team Any one can trust on The computers Dr for problems & queries  related to IT , Hardware & Software Maintenance.</h4>
              <h3 class="container-fluid">Vikas Singh</h3>
            </div>
         <div class="col-md-3 col-10 text-center">
          <br>
              <img src="assets/img/feedback1.jpg" height="300" width="160" class="py-5" alt=" Client image loading..">
            </div>            
            <div class="col-md-3 col-10 container-fluid">
              <i class="fa fa-quote-right fa-3x text-primary " aria-hidden="true"></i>
              <h4 class=" py-3 ">So for the  best laptop repairing services I have been through….. They Know the value of Customers Time & Money and Delivered the best services at reasonable price.</h4>
              <h3 class="">Vipin Rao</h3>
            </div>
